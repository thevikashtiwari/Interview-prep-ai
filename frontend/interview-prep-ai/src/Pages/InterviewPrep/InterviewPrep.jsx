...
const InterviewPrep = () => {
  ...
  const fetchSessionDetailsById = async () => {
    try {
      ...
      console.log("Kya jii kaya haal hai");
  ...
  const toggleQuestionPinStatus = async (questionId) => {
    try {
      ...
      if(response.data && response.data.question) {
        // toast.success('Qustion Pinned Successfully)
  ...
  const uploadMoreQuestions = async () => {
    try{
      ...
      // Call AI API togenerate questions
            ...
            <AnimatePresence>
              { sessionData?.questions?.map((data,index) => {
                ...
                return (
                  ...
                  layout// This is the prop that animate position changes
